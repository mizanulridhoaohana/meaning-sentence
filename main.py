...
def load_and_predict_model(sentence, selected_model):
    ...
    model_path = './model_1.joblib' if selected_model == 'Model 1' else './model_2.joblib'
    ...
    return prob_logical_and_meaningful[0] > 0.5

# Streamlit UI
st.title("Logical and Meaningful Sentence Checker")

# Radio button for selecting the model
selected_model = st.radio("Select Model:", ('Model 1 (balanced data)', 'Model 2'))
